    ...
    <>
      <form>
        <div className="form-group">
          ...
          Computer Science Department Ethics Application Form</h1>
          <p>
          ...
          <p>
            ...
            departmental ethics contact). Please check the following
            instructions before submitting:
          </p>
          <ul>
            <li>
              If you are a student, make sure you have discussed the ethics
              issues extensively with your supervisor.
            </li>
            <li>
            ...
            <li>
              You can find the CITY College ethics template forms at the this
              link
            </li>
          </ul>
          <strong>
