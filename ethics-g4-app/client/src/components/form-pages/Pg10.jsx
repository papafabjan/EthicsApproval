    ...
    <>
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ResearchProject" placeholder="Your answer"/>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="CoApllicantName" placeholder="Your answer"/>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="CoApplicantEmail" placeholder="Your answer"/>
            </div>
        </form>
    </>
    );
