      ...
      <div className="form-container">
        ...
        <div className="form-group">
          <label htmlFor="CoApplicantName">
            Co-Applicant Name(s) If there are others who will do the research
            with you, comma-separated
          </label>
          <input
            type="text"
            id="CoApplicantName"
        ...
        <div className="form-group">
          <label htmlFor="CoApplicantEmail">
            Co-Applicant email address(es)
          </label>
          <p>
            If there are others who will do the research with you,
            comma-separated
          </p>
          <input
            type="text"
        ...
        <div className="form-group">
          <label>
            ...
            <span style={{ color: "red" }}>*</span>
            <p>
              Select all that apply. If the country(ies) is not listed, please
              add them at the end
            </p>
          </label>
