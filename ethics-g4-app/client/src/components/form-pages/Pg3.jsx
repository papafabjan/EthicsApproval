      ...
      <div className="form-group">
        ...
        <div className="htmlForm-group">
            ...
            <div className="htmlForm-group">
                ...
                <li>
            <label>
              <input type="radio" name="Fund" value="Yes" onChange={handleRadioChange} /> No Funding
            </label>
            </li>
            <li>
            <label>
              <input type="radio" name="Fund" value="other" onChange={handleRadioChange} /> Other
            </label>
        ...
        <div className="htmlForm-group">
          ...
          <ul>
            <li>
              <label>
                <input type="checkbox" className="htmlForm-control" value="Bulgaria" />
                Bulgaria
              </label>
            </li>
            <li>
                <label>
                <input type="checkbox" className="htmlForm-control" id="ProjectPlace"/>
                Greece
                </label>
                </li>
                <li>
                <label>
                <input type="checkbox" className="htmlForm-control" id="Project"/>
                Romania
                </label>
                </li>
        ...
        <div className="htmlForm-group">
                <label htmlFor="HumanTissue">Involves human tissue?<span style={{ color: 'red' }}>*</span></label>
                <li>
                <label>
              <input type="radio" name="HumanTissue" value="Yes" onChange={handleRadioChange} /> Yes
            </label>
            </li>
            <li>
            <label>
              <input type="radio" name="HumanTissue" value="No" onChange={handleRadioChange} /> No
            </label>
            </li>
            </div>
            <div className="htmlForm-group">
                <label htmlFor="ClinicalMedical">Clinical trial or a medical device study?<span style={{ color: 'red' }}>*</span></label>
                <li>
                <label>
              <input type="radio" name="ClinicalMedical" value="Yes" onChange={handleRadioChange} /> Yes
            </label>
            </li>
            <li>
            <label>
              <input type="radio" name="ClinicalMedical" value="No" onChange={handleRadioChange} /> No
            </label>
            </li>
            </div>
            <div className="htmlForm-group">
                <label htmlFor="SocialCareServices">Involves social care services provided by a local authority?<span style={{ color: 'red' }}>*</span></label>
                <li>
                <label>
              <input type="radio" name="SocialCareServices" value="Yes" onChange={handleRadioChange} /> Yes
            </label>
            </li>
            <li>
            <label>
              <input type="radio" name="SocialCareServices" value="No" onChange={handleRadioChange} /> No
            </label>
            </li>
            </div>
      </form>
