    ...
    <>
      <div className="form-container">
        ...
        <div className="form-group">
          ...
          <p>
            What is the potential for physical and/or psychological
        ...
        <div className="form-group">
          ...
          <p>
            e.g., those who are ill, ethnic or racial minorities, those who do
            not speak the language used for the research, children, those
            economically disadvantaged, adults with diminished capacity
          </p>
          <ul>
            <li>
              <label>
