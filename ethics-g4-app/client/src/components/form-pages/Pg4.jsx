    ...
    <>
        <form>
            <div className="form-group">
                <label htmlFor="ResearchProject">Aims & Objectives <span style={{ color: 'red' }}>*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="CoApplicantName">Methodology <span style={{ color: 'red' }}>*</span></label>    
            ...
            <div className="form-group">
                <label htmlFor="CoApplicantEmail">Safety concerns <span style={{ color: 'red' }}>*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="StartDate">Does the research involve potentially highly sensitive topics? <span style={{ color: 'red' }}>*</span></label>
            ...
            <div className="form-group">
                <label htmlFor="StartDate">Sensitive Material/tools <span style={{ color: 'red' }}>*</span></label>
